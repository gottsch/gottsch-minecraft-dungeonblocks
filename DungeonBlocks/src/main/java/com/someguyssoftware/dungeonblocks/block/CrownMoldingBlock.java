...
public class CrownMoldingBlock extends FacadeShapeBlock {
	...
	private static final VoxelShape SOUTH_FACING_SHAPE = VoxelShapes.or(Block.box(0, 0, 0, 16, 3, 4),
			Block.box(0, 9, 0, 16, 16, 6), Block.box(0, 8, 2, 16, 9, 4),
			Block.box(0, 3, 0, 16, 9, 2));

	private static final VoxelShape WEST_FACING_SHAPE = VoxelShapes.or(Block.box(12, 0, 0, 16, 3, 16),
			Block.box(10, 9, 0, 16, 16, 16), Block.box(12, 8, 0, 14, 9, 16),
			Block.box(14, 3, 0, 16, 9, 16));

	// outer corners
	private static final VoxelShape TOP_LEFT_OUTER_SHAPE = VoxelShapes.or(Block.box(10, 9, 10, 16, 16, 16), // top
	...
	private static final VoxelShape TOP_RIGHT_OUTER_SHAPE = VoxelShapes.or(Block.box(0, 9, 10, 6, 16, 16),
			Block.box(0, 3, 14, 2, 9, 16), Block.box(2, 8, 12, 4, 16, 16),
			Block.box(0, 8, 12, 2, 16, 14), Block.box(0, 0, 12, 4, 3, 16));

	private static final VoxelShape BOTTOM_LEFT_OUTER_SHAPE = VoxelShapes.or(Block.box(10, 9, 0, 16, 16, 6),
			Block.box(14, 3, 0, 16, 9, 2), Block.box(12, 8, 0, 16, 16, 4),
			Block.box(14, 8, 2, 16, 16, 4), Block.box(12, 0, 0, 16, 3, 4));

	private static final VoxelShape BOTTOM_RIGHT_OUTER_SHAPE = VoxelShapes.or(Block.box(0, 9, 0, 6, 16, 6), // top
