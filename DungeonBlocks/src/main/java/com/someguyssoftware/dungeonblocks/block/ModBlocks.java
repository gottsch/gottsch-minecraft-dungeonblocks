...
public class ModBlocks {
	...
	public static final Block MOSSY_STONE_BRICKS_QUARTER_FACADE;
	...
	public static final Block MOSSY_STONE_BRICKS_FLUTED;
	...
	public static final Block MOSSY_STONE_BRICKS_FLUTED_FACADE;
	...
	public static final Block MOSSY_STONE_BRICKS_SILL;
	...
	public static final Block MOSSY_STONE_BRICKS_DOUBLE_SILL;
	...
	// cornice
	public static final Block STONE_CORNICE;
	public static final Block SMOOTH_STONE_CORNICE;
	public static final Block COBBLESTONE_CORNICE;
	public static final Block MOSSY_COBBLESTONE_CORNICE;
	public static final Block BRICKS_CORNICE;
	public static final Block STONE_BRICKS_CORNICE;
	public static final Block MOSSY_STONE_BRICKS_CORNICE;
	public static final Block CRACKED_STONE_BRICKS_CORNICE;
	public static final Block CHISELED_STONE_BRICKS_CORNICE;
	public static final Block OBSIDIAN_CORNICE;
	public static final Block SANDSTONE_CORNICE;
	public static final Block SMOOTH_SANDSTONE_CORNICE;
	public static final Block CHISELED_SANDSTONE_CORNICE;
	public static final Block CUT_SANDSTONE_CORNICE;
	public static final Block RED_SANDSTONE_CORNICE;
	public static final Block SMOOTH_RED_SANDSTONE_CORNICE;
	public static final Block CHISELED_RED_SANDSTONE_CORNICE;
	public static final Block CUT_RED_SANDSTONE_CORNICE;
	public static final Block GRANITE_CORNICE;
	public static final Block POLISHED_GRANITE_CORNICE;
	public static final Block DIORITE_CORNICE;
	public static final Block POLISHED_DIORITE_CORNICE;
	public static final Block ANDESITE_CORNICE;
	public static final Block POLISHED_ANDESITE_CORNICE;

	// crown molding
	public static final Block STONE_CROWN_MOLDING;
	public static final Block SMOOTH_STONE_CROWN_MOLDING;
	public static final Block COBBLESTONE_CROWN_MOLDING;
	public static final Block MOSSY_COBBLESTONE_CROWN_MOLDING;
	public static final Block BRICKS_CROWN_MOLDING;
	public static final Block STONE_BRICKS_CROWN_MOLDING;
	public static final Block MOSSY_STONE_BRICKS_CROWN_MOLDING;
	public static final Block CRACKED_STONE_BRICKS_CROWN_MOLDING;
	public static final Block CHISELED_STONE_BRICKS_CROWN_MOLDING;
	public static final Block OBSIDIAN_CROWN_MOLDING;
	public static final Block SANDSTONE_CROWN_MOLDING;
	public static final Block SMOOTH_SANDSTONE_CROWN_MOLDING;
	public static final Block CHISELED_SANDSTONE_CROWN_MOLDING;
	public static final Block CUT_SANDSTONE_CROWN_MOLDING;
	public static final Block RED_SANDSTONE_CROWN_MOLDING;
	public static final Block SMOOTH_RED_SANDSTONE_CROWN_MOLDING;
	public static final Block CHISELED_RED_SANDSTONE_CROWN_MOLDING;
	public static final Block CUT_RED_SANDSTONE_CROWN_MOLDING;
	public static final Block GRANITE_CROWN_MOLDING;
	public static final Block POLISHED_GRANITE_CROWN_MOLDING;
	public static final Block DIORITE_CROWN_MOLDING;
	public static final Block POLISHED_DIORITE_CROWN_MOLDING;
	public static final Block ANDESITE_CROWN_MOLDING;
	public static final Block POLISHED_ANDESITE_CROWN_MOLDING;

	// pillar base
	public static final Block STONE_PILLAR_BASE;
	public static final Block SMOOTH_STONE_PILLAR_BASE;
	public static final Block COBBLESTONE_PILLAR_BASE;
	public static final Block MOSSY_COBBLESTONE_PILLAR_BASE;
	public static final Block BRICKS_PILLAR_BASE;
	public static final Block STONE_BRICKS_PILLAR_BASE;
	public static final Block MOSSY_STONE_BRICKS_PILLAR_BASE;
	public static final Block CRACKED_STONE_BRICKS_PILLAR_BASE;
	public static final Block CHISELED_STONE_BRICKS_PILLAR_BASE;
	public static final Block OBSIDIAN_PILLAR_BASE;
	public static final Block SANDSTONE_PILLAR_BASE;
	public static final Block SMOOTH_SANDSTONE_PILLAR_BASE;
	public static final Block CHISELED_SANDSTONE_PILLAR_BASE;
	public static final Block CUT_SANDSTONE_PILLAR_BASE;
	public static final Block RED_SANDSTONE_PILLAR_BASE;
	public static final Block SMOOTH_RED_SANDSTONE_PILLAR_BASE;
	public static final Block CHISELED_RED_SANDSTONE_PILLAR_BASE;
	public static final Block CUT_RED_SANDSTONE_PILLAR_BASE;
	public static final Block GRANITE_PILLAR_BASE;
	public static final Block POLISHED_GRANITE_PILLAR_BASE;
	public static final Block DIORITE_PILLAR_BASE;
	public static final Block POLISHED_DIORITE_PILLAR_BASE;
	public static final Block ANDESITE_PILLAR_BASE;
	public static final Block POLISHED_ANDESITE_PILLAR_BASE;

	// pillar
	public static final Block STONE_PILLAR;
	public static final Block SMOOTH_STONE_PILLAR;
	public static final Block COBBLESTONE_PILLAR;
	public static final Block MOSSY_COBBLESTONE_PILLAR;
	public static final Block BRICKS_PILLAR;
	public static final Block STONE_BRICKS_PILLAR;
	public static final Block MOSSY_STONE_BRICKS_PILLAR;
	public static final Block CRACKED_STONE_BRICKS_PILLAR;
	public static final Block CHISELED_STONE_BRICKS_PILLAR;
	public static final Block OBSIDIAN_PILLAR;
	public static final Block SANDSTONE_PILLAR;
	public static final Block SMOOTH_SANDSTONE_PILLAR;
	public static final Block CHISELED_SANDSTONE_PILLAR;
	public static final Block CUT_SANDSTONE_PILLAR;
	public static final Block RED_SANDSTONE_PILLAR;
	public static final Block SMOOTH_RED_SANDSTONE_PILLAR;
	public static final Block CHISELED_RED_SANDSTONE_PILLAR;
	public static final Block CUT_RED_SANDSTONE_PILLAR;
	public static final Block GRANITE_PILLAR;
	public static final Block POLISHED_GRANITE_PILLAR;
	public static final Block DIORITE_PILLAR;
	public static final Block POLISHED_DIORITE_PILLAR;
	public static final Block ANDESITE_PILLAR;
	public static final Block POLISHED_ANDESITE_PILLAR;
	...
	public static final Block MOSSY_STONE_BRICKS_WALL_SCONCE;
	...
	public static final Block GRATE;
	...
	static {
		...
		STONE_FACADE = new FacadeBlock(DungeonBlocks.MOD_ID, BlockID.STONE_FACADE_ID,
				Block.Properties.create(Material.ROCK, MaterialColor.DIRT).hardnessAndResistance(1.5F, 6.0F));
		...
		MOSSY_COBBLESTONE_FACADE = new FacadeBlock(DungeonBlocks.MOD_ID, BlockID.MOSSY_COBBLESTONE_FACADE_ID,
				Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 6.0F));
		...
		STONE_BRICKS_FACADE = new FacadeBlock(DungeonBlocks.MOD_ID, BlockID.STONE_BRICKS_FACADE_ID,
				Block.Properties.create(Material.ROCK).hardnessAndResistance(1.5F, 6.0F));
		...
		OBSIDIAN_FACADE = new FacadeBlock(DungeonBlocks.MOD_ID, BlockID.OBSIDIAN_FACADE_ID,
				Block.Properties.create(Material.ROCK, MaterialColor.BLACK).hardnessAndResistance(50.0F, 1200.0F));

		SANDSTONE_FACADE = new FacadeBlock(DungeonBlocks.MOD_ID, BlockID.SANDSTONE_FACADE_ID,
				Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(0.8F));
		...
		DIORITE_FACADE = new FacadeBlock(DungeonBlocks.MOD_ID, BlockID.DIORITE_FACADE_ID,
				Block.Properties.create(Material.ROCK, MaterialColor.QUARTZ).hardnessAndResistance(1.5F, 6.0F));
		...
		STONE_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID, BlockID.STONE_WALL_SCONCE_ID,
				Block.Properties.create(Material.ROCK, MaterialColor.DIRT).hardnessAndResistance(1.5F, 6.0F)
						.doesNotBlockMovement().lightValue(14).sound(SoundType.WOOD));
		...
		MOSSY_COBBLESTONE_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID, BlockID.MOSSY_COBBLESTONE_WALL_SCONCE_ID,
				Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 6.0F).doesNotBlockMovement()
						.lightValue(14).sound(SoundType.WOOD));
		...
		STONE_BRICKS_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID, BlockID.STONE_BRICKS_WALL_SCONCE_ID,
				Block.Properties.create(Material.ROCK).hardnessAndResistance(1.5F, 6.0F).doesNotBlockMovement()
						.lightValue(14).sound(SoundType.WOOD));
		MOSSY_STONE_BRICKS_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID,
				BlockID.MOSSY_STONE_BRICKS_WALL_SCONCE_ID, Block.Properties.create(Material.ROCK)
						.hardnessAndResistance(1.5F, 6.0F).doesNotBlockMovement().lightValue(14).sound(SoundType.WOOD));
		CRACKED_STONE_BRICKS_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID,
				BlockID.CRACKED_STONE_BRICKS_WALL_SCONCE_ID, Block.Properties.create(Material.ROCK)
						.hardnessAndResistance(1.5F, 6.0F).doesNotBlockMovement().lightValue(14).sound(SoundType.WOOD));
		CHISELED_STONE_BRICKS_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID,
				BlockID.CHISELED_STONE_BRICKS_WALL_SCONCE_ID, Block.Properties.create(Material.ROCK)
						.hardnessAndResistance(1.5F, 6.0F).doesNotBlockMovement().lightValue(14).sound(SoundType.WOOD));
		...
		CHISELED_SANDSTONE_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID,
				BlockID.CHISELED_SANDSTONE_WALL_SCONCE_ID, Block.Properties.create(Material.ROCK, MaterialColor.SAND)
						.hardnessAndResistance(0.8F).doesNotBlockMovement().lightValue(14).sound(SoundType.WOOD));
		...
		SMOOTH_RED_SANDSTONE_WALL_SCONCE = new SconceBlock(DungeonBlocks.MOD_ID,
				BlockID.SMOOTH_RED_SANDSTONE_WALL_SCONCE_ID, Block.Properties.create(Material.ROCK, MaterialColor.SAND)
						.hardnessAndResistance(0.8F).doesNotBlockMovement().lightValue(14).sound(SoundType.WOOD));
		...
		GRATE = new GrateBlock(DungeonBlocks.MOD_ID, BlockID.GRATE_ID,
				Block.Properties.create(Material.IRON, MaterialColor.BLACK).hardnessAndResistance(1.5F, 6.0F));
