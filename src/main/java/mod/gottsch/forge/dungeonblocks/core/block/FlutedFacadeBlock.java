...
public class FlutedFacadeBlock extends FacadeShapeBlock {
	...
	private static final VoxelShape STRAIGHT_SHAPE = Shapes.or(NORTH_FACING_PART, N1_PART, N2_PART);
	...
	private static final VoxelShape OUTER_SHAPE = Block.box(10, 0, 10, 16, 16, 16);
