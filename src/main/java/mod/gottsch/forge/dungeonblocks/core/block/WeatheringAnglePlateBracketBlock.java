 ...
 *
 */
public class WeatheringAnglePlateBracketBlock extends AnglePlateBracketBlock implements ModWeatheringCopper {
   private final WeatherState weatherState;

   public WeatheringAnglePlateBracketBlock(WeatherState weatherState, Properties properties) {
      super(properties);
