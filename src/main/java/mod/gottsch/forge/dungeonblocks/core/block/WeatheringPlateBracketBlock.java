...
/**
 * @author Mark Gottschling on May 12, 2025
 *
 */
public class WeatheringPlateBracketBlock extends PlateBracketBlock implements ModWeatheringCopper {
   private final WeatherState weatherState;

   public WeatheringPlateBracketBlock(WeatherState weatherState, Properties properties) {
      super(properties);
