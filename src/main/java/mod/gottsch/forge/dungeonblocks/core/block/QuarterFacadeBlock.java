...
public class QuarterFacadeBlock extends FacadeShapeBlock {
	 ...
	 */
	private static final VoxelShape STRAIGHT_SHAPE = Block.box(0.0D, 0.0D, 12.0D, 16.0D, 16.0D, 16.0D);

	private static final VoxelShape INNER_SHAPE = Shapes.or(STRAIGHT_SHAPE,
			Block.box(12.0D, 0D, 0D, 16.0D, 16.0D, 12.0D));

	private static final VoxelShape OUTER_SHAPE = Block.box(12.0D, 0D, 12.0D, 16.0D, 16.0D, 16.0D);
