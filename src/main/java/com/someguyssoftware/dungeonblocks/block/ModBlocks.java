...
import static com.someguyssoftware.dungeonblocks.item.ModItems.ITEM_PROPERTIES;
...
public class ModBlocks {
	...
	static {
		...
		// registser items
		fromBlock(ModBlocks.ANDESITE_CORNICE, ModItems.ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.ANDESITE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.BLACKSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BLACKSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_DEEPSLATE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_POLISHED_BLACKSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_RED_SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CHISELED_SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CHISELED_STONE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_DEEPSLATE_TILES_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_POLISHED_BLACKSTONE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CRACKED_STONE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLED_DEEPSLATE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.COBBLESTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.COBBLESTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_RED_SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.CUT_SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.CUT_SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.DEEPSLATE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.DEEPSLATE_TILES_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DEEPSLATE_TILES_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.DIORITE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.DIORITE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.GILDED_BLACKSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GILDED_BLACKSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.GRANITE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.GRANITE_WALL_SCONCE, ITEM_PROPERTIES);
				
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_COBBLESTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.MOSSY_STONE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.OBSIDIAN_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.OBSIDIAN_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.POLISHED_ANDESITE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_ANDESITE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_BLACKSTONE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DEEPSLATE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.POLISHED_DIORITE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_DIORITE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.POLISHED_GRANITE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.POLISHED_GRANITE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.RED_SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.RED_SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
				
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_RED_SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_SANDSTONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.SMOOTH_STONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.SMOOTH_STONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.STONE_BRICKS_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_BRICKS_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.STONE_CORNICE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_CROWN_MOLDING, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_DOUBLE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_FLUTED, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_FLUTED_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_PILLAR, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_PILLAR_BASE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_QUARTER_FACADE, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_SILL, ITEM_PROPERTIES);
		fromBlock(ModBlocks.STONE_WALL_SCONCE, ITEM_PROPERTIES);
		
		fromBlock(ModBlocks.GRATE, ITEM_PROPERTIES);
	}
