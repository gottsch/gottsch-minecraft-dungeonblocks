...
- **Stone Sarcophagus** and **Deepslate Sarcophagus** — a two-block tomb with a carved effigy lying on its lid. Right-click and the lid grinds smoothly aside to show the hollow tomb inside; right-click again to slide it closed. A prop: it holds nothing. Placed like a bed, the effigy's head away from you.
...
- **Gibbet** — a full-width iron cage with a full-size skeleton in it, hung on a chain from the block above: three blocks tall in all, for a gallows, a dungeon cell or a crossroads.
